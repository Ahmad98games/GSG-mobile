...
import type { NotificationPressAction, NotificationFullScreenAction } from './Notification';
...
export interface NotificationAndroid {
   ...
   *
   * The color can be a predefined system `AndroidColor` or an industrial hex code.
   *
